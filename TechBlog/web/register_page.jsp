<%-- 
    ...
    Created on : 10 Sep, 2023, 11:30:04 PM
    Author     : ASUS
--%>
        ...
        <main class="primary-background banner-background" style="padding-bottom:80px;">
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card">
                        <div class="card-header text-center text-white primary-background"><span class="fa fa-3x fa-user-circle-o"></span>
                            <br>
                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="post">
                                ...
                                <br>
                                <div class="container text-center" id="loader" style="display:none;"><span  class="fa fa-refresh fa-spin fa-3x">

                                    </span> <h4>Please Wait ...</h4></div>
                                <br>
